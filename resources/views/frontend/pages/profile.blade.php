                                    ...
                                    <form action="{{ route('user.profile-update') }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group mb-2 col-md-8 col-lg-8">
                                                <input type="date" name="passport_expire_till" class="form-control "
                                                    value="{{ Auth::user()->passport_expire_till }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                                    ...
                                                    @if (Auth::user()->avatar_original != null)
                                                        <div class="col-md-4 col-sm-4 col-xs-6">
                                                            <div class="img-upload-preview" style="height: 150px;">
                                                                <img loading="lazy"
                                                                    src="{{ url(Auth::user()->avatar_original) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="ml-3 mr-3 col-md-8 col-lg-8">
                                                <div class="row" id="passport">
                                                    @if (is_array(json_decode(Auth::user()->passport)))
                                                        @foreach (json_decode(Auth::user()->passport) as $key => $passport)
                                                            {{-- @if (Auth::user()->passport != null) --}}
                                                            <div class="col-md-4 col-sm-4 col-xs-6">
                                                                <div class="img-upload-preview" style="height: 150px;">
                                                                    <img loading="lazy" src="{{ url($passport) }}"
                                                                        alt="" class="img-responsive">
                                                                    <input type="hidden" name="previous_avatar_original"
                                                                        value="{{ $passport }}">
                                                                    <button type="button"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="ml-3 mr-3 col-md-8 col-lg-8">
                                                <div class="row" id="nid">
                                                    @if (is_array(json_decode(Auth::user()->nid)))
                                                        @foreach (json_decode(Auth::user()->nid) as $key => $nid)
                                                            {{-- @if (Auth::user()->nid != null) --}}
                                                            <div class="col-md-4 col-sm-4 col-xs-6">
                                                                <div class="img-upload-preview" style="height: 150px;">
                                                                    <img loading="lazy" src="{{ url($nid) }}"
                                                                        alt="" class="img-responsive">
                                        ...
                                        <div class="row mt-2">
                                            <label for="driving_licence" class="c-form-label col-md-3 col-lg-3">Driving
                                                Licence</label>
                                            <div class="ml-3 mr-3 col-md-8 col-lg-8">
                                                @if (Auth::user()->driving_licence != null)
                                                    <a href="{{ url(Auth::user()->driving_licence) }}"
                                                        target="_blank">{{ explode('/', Auth::user()->driving_licence)[2] }}</a>
                                                @endif
                                        ...
                                        <div class="row mt-4">
                                            <label for="birth_certificate" class="c-form-label col-md-3 col-lg-3">Birth
                                                Certificate</label>
                                            <div class="form-group mb-2 col-md-8 col-lg-8">
                                                @if (Auth::user()->birth_certificate != null)
                                                    <a href="{{ url(Auth::user()->birth_certificate) }}"
                                                        target="_blank">{{ explode('/', Auth::user()->birth_certificate)[2] }}</a>
                                                @endif
