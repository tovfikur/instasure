...
@section('title', 'Mediclaim Insurance Quote Form ')
@push('css')
                        ...
                        <div class="tab_content m-4 row">
                            <div class="tabs_item col-lg-12 col-md-12 col-sm-12" id="mainDiv">
                                ...
                                <form id="choice_form" method="post"
                                    action="{{ route('insurance.quotation.calculation') }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" name="dob" id="dob" class="form-control"
                                                    value="{{ date_format_custom(Auth::user()->dob, 'm/d/Y') }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" name="passport_number" id="passport_number"
                                                    value="{{ Auth::user()->passport_number }}" class="form-control"
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" name="passport_expire_till" id="passport_expire_till"
                                                    value="{{ date_format_custom(Auth::user()->passport_expire_till, 'm/d/Y') }}"
...
@push('js')
    ...
    <script>
        ...
        function getInsurancePriceHistory() {
            ...
            $.ajax({
                type: "POST",
                url: '{{ route('insurance.provider.data') }}',
                data: form_data,
        ...
        $("#choice_form").on("submit", function(event) {
            ...
            $.ajax({
                type: "POST",
                url: '{{ route('insurance.quotation.calculation') }}',
