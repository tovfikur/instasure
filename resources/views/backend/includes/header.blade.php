...
<nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a target="_blank" href="{{ url('/') }}" class="nav-link" data-toggle="frontend"
    ...
    <ul class="navbar-nav ml-auto">
        ...
        @if (Auth::user()->user_type == 'service_center')
            @include('backend.partials.serviceCenterNotification')
        @elseif(Auth::user()->user_type == 'admin')
            @include('backend.partials.adminNotification')
        @elseif(Auth::user()->user_type == 'admin')
        @endif
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <div class="image text-center">
                    <img src="{{ asset('backend/images/logo.png') }}" width="60px" height="60px"
                ...
                <div class="float-left">
                    @if (Auth::user()->user_type == 'child_dealer')
                        <a href="{{ route('childDealer.profile') }}" class="dropdown-item">
