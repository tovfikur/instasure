...
@section('content')
    <!-- Breadcrumb -->
    @includeIf('backend.child_dealer.withdraw_request.breadcrumb', [
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                ...
                                <input type="number" name="amount" class="form-control"
                                    max="{{ $childDealer->dealer_balance }}">
                            </div>
                            <div class="form-group col-6">
    ...
    <script>
        ...
        $(function() {
            $('#datatable').DataTable({
                ...
                'iDisplayLength': 10,
                ajax: '{{ route('childDealer.commission_withdraw_request_ajax', ['child']) }}',
                columns: [
