    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-body">
                <form action="{{ route('childDealer.commission_withdraw_request_update', $insuranceWithdrawRequest) }}"
                    id="edit_form">
                                    ...
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <a class="d-inline-block">
                                                ...
                                                <span
                                                    class="badge @if ($status == 'paid') badge-success @elseif($status == 'received') badge-info @else badge-warning @endif ">
                                                    {{ ucfirst($status) }}
                                                </span>
                                        ...
                                        <select class="form-control" name="status" id="status">
                                            ...
                                            @else
                                                <option value="received"
                                                    @if ($status == 'received') selected @endif>
                                                    Received</option>
                                            @endif
