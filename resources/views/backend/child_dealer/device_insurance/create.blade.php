        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-info card-outline">
                    ...
                    <!-- form start -->
                    <form id="form_id" role="form" action="{{ route('childDealer.device-insurance.getInsPrice') }}"
                        method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" value="{{ $deviceSubcategories }}" name="device_subcategory_id">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ old('customer_name') ? old('customer_name') : $user->name }}"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="customer_phone"
                                        value="{{ old('customer_phone') ? old('customer_phone') : $user->phone }}"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="email" class="form-control" name="customer_email"
                                        value="{{ old('customer_email') ? old('customer_email') : $user->email }}"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" class="form-control" name="device_price"
                                        value="{{ old('device_price') }}" id="device_price"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="battery_number"
                                        value="{{ old('battery_number') }}" id="battery_number"
                                        placeholder="Enter Battery Number">
                                </div>


                                <div class="form-group col-md-4">
                                    <label for="imei_one">IMEI One @if ($imei_check == 0)
                                    ...
                                    <input type="number" class="form-control" name="imei_one"
                                        value="{{ old('imei_one') }}" id="imei_one" placeholder="Enter IMEI One"
                                        data-imei_check="{{ $imei_check }}" minlength="15" maxlength="25" required>
                                </div>

                                <div class="form-group col-md-4">
                                    <label for="imei_two">IMEI Two</label>
                                    <input type="number" class="form-control" name="imei_two"
                                        value="{{ old('imei_two') }}" id="imei_two" placeholder="Enter IMEI Two"
                                        data-imei_check="{{ $imei_check }}" maxlength="25" minlength="15">
                                </div>
                            </div>
                            <div class="row">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" action="{{ route('childDealer.customer-insert') }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="phone"
                                        value="{{ old('phone') }}" id="name" placeholder="Enter phone" required>
                                </div>
                            </div>
...
@push('js')
    <script>
        ...
        function getDeviceSubcategory() {
            ...
            $.post('{{ route('childDealer.device_subcategories') }}', {
                _token: '{{ csrf_token() }}',
        ...
        function getDeviceModel() {
            ...
            $.post('{{ route('childDealer.device_models') }}', {
                _token: '{{ csrf_token() }}',
                brand_id: brand_id
            }, function(data) {
