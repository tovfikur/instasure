        ...
        <section class="invoice">
            ...
            <div class="row invoice-info mt-5" style="background-color: #f3f3f3">
                ...
                <div class="col-sm- 4 col-md-4 invoice-col">
                    ...
                    <address>
                        <b>Name:</b>
                        {{ $deviceInsurance->child_dealer_id ? $deviceInsurance->childDealer->com_org_inst_name : '' }}<br>
                        <b>Phone:</b> {{ $deviceInsurance->childDealer->user->phone }}<br>
                        <b>Email:</b> {{ $deviceInsurance->childDealer->user->email }}<br>
                    </address>
                </div>
                <!-- /.col -->
                <div class="col-sm-3 col-md-3 invoice-col ">
                    <b>Invoice Number: </b> {{ $deviceInsurance->invoice_code }}<br>
                    <br>
                    <b>Date:</b> {{ date('d/m/Y', strtotime($deviceInsurance->created_at)) }}<br>
                </div>
                <!-- /.col -->
            </div>
            <!-- /.row -->
                    ...
                    <table class="table table-bordered mt-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $device_info->device_price }} {{ config('settings.currency') }}</td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            ...
                            @foreach ($insurance_infos as $insurance_info)
                                <tr>
                                    ...
                                    <td>{{ $insurance_info->price }} {{ config('settings.currency') }}</td>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tr>
                                ...
                                <td>{{ $deviceInsurance->sub_total }} {{ config('settings.currency') }}</td>
                            </tr>
                            <tr>
                                <th>VAT%:</th>
                                <td> {{ $deviceInsurance->total_vat }} {{ config('settings.currency') }}</td>
                            </tr>
                            <tr>
                                <th>Total:</th>
                                <td>{{ $deviceInsurance->grand_total }} {{ config('settings.currency') }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
