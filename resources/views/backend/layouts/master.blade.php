...
<body class="hold-transition ">
    <div class="wrapper">
        ...
        @elseif (Auth::check() && Auth::user()->user_type == 'parent_dealer')
            @include('backend.includes.parent_dealer_sidebar')
        @elseif (Auth::check() && Auth::user()->user_type == 'child_dealer')
            @include('backend.includes.child_dealer_sidebar')
        @elseif (Auth::check() && Auth::user()->user_type == 'service_center')
            @include('backend.includes.service_center_sidebar')
        @elseif (Auth::check() && Auth::user()->user_type == 'collection_center')
            @include('backend.includes.collection_center_sidebar')
        @endif
