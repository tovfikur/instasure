...
@section("title","Device Categories List")
@push('css')
                ...
                <div class="card card-info card-outline">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{route('admin.device-categories.create')}}">
                    ...
                    <div class="card-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            @foreach($deviceCategories as $key => $deviceCategory)
                                <tr>
                                    <td>{{$key + 1}}</td>
                                    <td>{{$deviceCategory->name}}</td>
                                    <td>
                                        <img src="{{asset('uploads/device_categories/'.$deviceCategory->icon)}}" width="32" height="32" alt="">
                                    </td>
                                    <td>
                                        <a class="btn btn-info waves-effect" href="{{route('admin.device-categories.edit',$deviceCategory->id)}}">
