@php
$page_heading = 'Edit Travel Ins Plans Category';
@endphp
...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card card-info card-outline">
            ...
            <!-- form start -->
            <form role="form" action="{{ route('admin.travel-ins-plans-categories.update', $TIPCategory->id) }}"
                        ...
                        <div class="col-md-8 offset-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="plan_title" id="plan_title"
                                    value="{{ $TIPCategory->plan_title }}" required>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="county_details" id="county_details"
                                    value="{{ $TIPCategory->county_details }}" required>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control demo-select2" name="country_type" id="country_type" required>
                                    ...
                                    <option value="Schengen"
                                        {{ $TIPCategory->country_type == 'Schengen' ? 'selected' : '' }}>
                                        Schengen
                                        Country
                                    </option>
                                    <option value="Non Schengen"
                                        {{ $TIPCategory->country_type == 'Non Schengen' ? 'selected' : '' }}>Non
                                        Schengen
                                        Country</option>
                                </select>
                            </div>
