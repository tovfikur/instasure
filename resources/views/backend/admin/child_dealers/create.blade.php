        ...
        <div class="row">
            <div class="col-12   ">
                ...
                <div class="card card-info card-outline">
                    ...
                    <!-- form start -->
                    <form role="form" action="{{ route('admin.child-dealers.store') }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="city"
                                        value="{{ old('city') }}" id="city" placeholder="Ex: Dhaka" required>
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="area">Area<small class="text-danger">(required)</small></label>
                                    <input type="text" class="form-control" name="area"
                                        value="{{ old('area') }}" id="area" placeholder="Ex: Dhanmondi" required>
                                </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="parent_id" id="parent_id" class="form-control">
                                        @foreach ($parents as $parent)
                                            <option value="{{ $parent->id }}">{{ $parent->com_org_inst_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
