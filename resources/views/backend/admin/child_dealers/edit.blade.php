        ...
        <div class="row">
            <div class="col-12   ">
                ...
                <div class="card card-info card-outline">
                    ...
                    <!-- form start -->
                    <form role="form" action="{{ route('admin.child-dealers.update', $dealerDetails->id) }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="contact_person_name"
                                        value="{{ $dealerDetails->contact_person_name }}" id="contact_person_name" required>
                                </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" name="commission_amount"
                                        value="{{ $dealerDetails->commission_amount }}" id="com_org_inst_name" required>
                                </div>
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="parent_id" id="parent_id" class="form-control">
                                        @foreach ($parents as $parent)
                                            <option value="{{ $parent->id }}"
                                                {{ $dealerDetails->parent_id == $parent->id ? 'selected' : '' }}>
                                                {{ $parent->com_org_inst_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="can_sale_old_device" id="can_sale_old_device" class="form-control">
                                        <option value="0" @if ($dealerDetails->can_sale_old_device == 0) selected @endif>No
                                        </option>
                                        <option value="1" @if ($dealerDetails->can_sale_old_device == 1) selected @endif>Yes
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('admin.child-dealers.show', $dealerDetails->id) }}"
