            ...
            <div class="col-10 offset-1">
                ...
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title float-left">Add Promo Code</h3>
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{route('admin.promo-codes.store')}}" method="post"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" id="code" name="code" class="form-control" placeholder="Enter Promo Code">
                                </div>
                                <div class="form-group col-md-3">
                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <select class=" form-control" name="inc_exc_type"
                                            id="inc_exc_type" required>
                                                        ...
                                                        <li class="list-group-item m-0 mr-2 mb-1">
                                                            <label for="" class="m-0 p-0">
                                                                <input type="radio" class="parent_id" name="parent_id"
                                                                       ...
                                                                       value="{{$parent->id}}"> {{$parent->com_org_inst_name}}
                                                            </label>
                                                        </li>
                                                    @endforeach
                                                </ul>
