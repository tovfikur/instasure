                        ...
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>Receiveable Amount:</b> <a class="float-right">
                                        {{ $dealerDetails->dealer_balance }}
                                        {{ config('settings.currency') }}
                                    </a>
                                </li>
                                <li class="list-group-item">
                                    <b>Login ID:</b> <a class="float-right">{{ $dealerDetails->user->phone }}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Dealer Type:</b> <a
                    ...
                    <div class="card card-info card-outline">
                        <div class="card-header p-2">
                            <h4>{{ $dealerDetails->com_org_inst_name }}
                                <a href="{{ route('parentDealer.child-dealers.edit', $dealerDetails->id) }}"
