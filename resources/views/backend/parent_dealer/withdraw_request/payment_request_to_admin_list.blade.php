@php
$page_heading = 'Service Charge Withdraw Request to Admin';
@endphp
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">
                            <a
                                href="{{ route('parentDealer.device_insurance_withdraw_request_to_admin_list', ['status' => 'all']) }}">
                        ...
                        <li class="breadcrumb-item">
                            <a
                                href="{{ route('parentDealer.device_insurance_withdraw_request_to_admin_list', ['status' => 'paid']) }}">
    ...
    <script>
        ...
        $(function() {
            $('#claim_request_table').DataTable({
                ...
                'iDisplayLength': 10,
                ajax: '{{ route('parentDealer.device_insurance_withdraw_request_to_admin_list_ajax', [$status]) }}',
                columns: [{
                        data: 'checkbox',
                        name: 'checkbox',
                        searching: false,
