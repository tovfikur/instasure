<?php
$page_heading = 'Add A New Child dealer';
?>
        ...
        <div class="row">
            <div class="col-12   ">
                ...
                <div class="card card-info card-outline">
                    ...
                    <!-- form start -->
                    <form role="form" action="<?php echo e(route('admin.child-dealers.store')); ?>" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="city"
                                        value="<?php echo e(old('city')); ?>" id="city" placeholder="Ex: Dhaka" required>
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="area">Area<small class="text-danger">(required)</small></label>
                                    <input type="text" class="form-control" name="area"
                                        value="<?php echo e(old('area')); ?>" id="area" placeholder="Ex: Dhanmondi" required>
                                </div>
                                ...
                                <div class="form-group col-md-3">
                                    <label for="parent_id">Parent Dealer<small
                                            class="text-danger">(required)</small></label>
                                    <select name="parent_id" id="parent_id" class="form-control">
                                        <?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($parent->id); ?>"><?php echo e($parent->com_org_inst_name); ?>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea name="com_address" id="com_address" class="form-control" rows="1" required
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/instaweb/resources/views/backend/admin/child_dealers/create.blade.php ENDPATH**/ ?>