<?php $__env->startSection('title', 'Mobile Phone Protection'); ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="image text-center">
                            <img src="<?php echo e(asset('frontend/assets/img/products/phone-1.jpg')); ?>" alt="image">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-services-box">
                    <figure>
                        <img src="<?php echo e(asset('frontend/assets/img/products/approved.png')); ?>" alt="approved.png">
                    </figure>
                    <h3>APPROVAL</h3>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-services-box">
                    <figure>
                        <img src="<?php echo e(asset('frontend/assets/img/products/deductibles.png')); ?>" alt="deductibles.png">
                    </figure>
                    <h3>DEDUCTIBLES</h3>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-services-box">
                    <figure>
                        <img src="<?php echo e(asset('frontend/assets/img/products/service-center.png')); ?>" alt="service-center.png">
                    </figure>
        ...
        <div class="insurance-details-header">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 col-md-5 mt-5">
                    <div class="image text-center">
                        <img src="<?php echo e(asset('frontend/assets/img/products/dropped-my-mobile-1.jpg')); ?>" alt="image">
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="paymentBox">
                            <img src="<?php echo e(asset('frontend/assets/img/products/android-mobile-phone-details-menu.jpg')); ?>"
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="paymentBox">
                            <img src="<?php echo e(asset('frontend/assets/img/products/external-check.jpg')); ?>" alt="image">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="paymentBox">
                            <img src="<?php echo e(asset('frontend/assets/img/products/complete-payment.jpg')); ?>" alt="image">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5 mt-5">
                        <div class="image text-center">
                            <img src="<?php echo e(asset('frontend/assets/img/products/claims.jpg')); ?>" alt="image">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 mt-5">
                        <div class="content">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/instaweb/resources/views/frontend/pages/mobile_phone_protection.blade.php ENDPATH**/ ?>