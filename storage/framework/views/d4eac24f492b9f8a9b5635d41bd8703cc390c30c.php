                            ...
                            <tbody>
                                <?php $__currentLoopData = $childDealers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $childDealer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="<?php echo e(asset('uploads/dealer-logo/photo/' . $childDealer->logo)); ?>"
                                        ...
                                        <td><?php echo e($childDealer->parent->com_org_inst_name); ?></td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="bg-dark dropdown-item"
                                                        href="<?php echo e(route('admin.child-dealers.show', $childDealer->id)); ?>">
                                                        <i class="fa fa-eye text-success"></i> Details
                                                    </a>
                                                    <a class="bg-dark dropdown-item"
                                                        href="<?php echo e(route('admin.child-dealers.edit', $childDealer->id)); ?>">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/instaweb/resources/views/backend/admin/child_dealers/index.blade.php ENDPATH**/ ?>