        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb float-sm-right mt-1">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('admin.categories.index')); ?>" class="btn btn-info btn-sm">
...
<!-- /.content-header -->
<?php /**PATH /var/www/html/instaweb/resources/views/backend/admin/categories/breadcrumb.blade.php ENDPATH**/ ?>